...
assessmentButton.onclick=()=>{
    ...
    //TODO 診断結果表示エリアの作成
    //createElementとは要素を作成する
    //innnerTextとは内側のテキスト
    //appendChildは子を追加する

    //空文字列を追加して、ボタンを押しても連続で表示できないようにする
...
/**
 * 名前の文字列を渡すと診断結果を返す関数
 * @param{string}userNameユーザーの名前 paramは引数 userNameは引数の名前
 * @return{string}診断結果 stringは値の型が文字列型であること
 */
function assessment(userName){
    ...
    }//for文を使って、名前の文字全ての文字のコードを足し合わせている
